...
// // Получите все флажки в упорядоченном списке
// const checkboxes = document.querySelectorAll('ol input[type="checkbox"]');

// // Создаем пустой массив для хранения проверенных значений
// const checkedValues = [];

// // Перебираем все чекбоксы и проверяем, отмечены ли они галочками
// checkboxes.forEach(checkbox => {
// if (checkbox.checked) {
// // Если флажок установлен, добавьте его значение в массив checkedValues
// checkedValues.push(checkbox.value);
// }
// });

// // Выводим в лог массив проверенных значений
...
const MealDetails = () => {
  ...
  const checkChangeController = () => {
    ...
    // Создайте пустой массив для хранения проверенных значений
    const checkedValues = [];

    // Пройдитесь по всем чекбоксам и проверьте, установлены ли они.
    checkboxes.forEach((checkbox) => {
      if (checkbox.checked) {
        // Если флажок установлен, добавьте его значение в массив checkedValues
        checkedValues.push(checkbox.value);
    ...
    // Выведите массив проверенных значений
    setShoppingList(checkedValues);
